...
database_folder, model_folder = "test", "HSX_vessel_5cm"
...
# Plate Dimensions, Bounds, and Penalties 
PHI1 = -22.5
PHI2 = 22.5 
...
# Set firstwall as PFC for initial connection length calculations and divertor load approximations
if rank == 0:
