...
C 20240626  Eliminated Computed GOTOs (in Blocks D and F). (ACH)
C     
...
C   20031105  Restored 'own' variables to Common block /DLS001/, to
C             enable interrupt/restart feature. (ACH)
C   20240626  Replaced Computed GO TO with IF blocks. (ACH)
...
C   20031105  Restored 'own' variables to Common block /DLS001/, to
C             enable interrupt/restart feature. (ACH)
C   20240624  Replaced Computed GO TO with IF ... THEN blocks. (ACH)
...
C   20031105  Restored 'own' variables to Common block /DLS001/, to
C             enable interrupt/restart feature. (ACH)
C   20240626  Replaced computed GO TO with IF statements. (ACH)
